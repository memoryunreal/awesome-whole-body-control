...
_Latest digest: **2026-09-25** — **26 new**, **3 updated**._

### Added by Section

- `02_hoi_motion`: 1 entry — HIGenNTO (2609.22611).
- `03_wbc_tracking`: 15 entries — FootQuery (2609.21447), LIMBO (2609.22075), EmoPose (2609.23414), UniPoint (2609.23666), Smoothness as a Constraint for Stable Humanoid Locomotion (2609.24552), PredActor (2609.24840), PLAT (2609.25754), Sample, Simulate, Select (2609.26420), Humanoid Locomotion with a Fly-Inspired Recurrent Controller (2609.27001), Learning Expressive Humanoid Locomotion from Monocular Runway Videos for Robot Fashion Shows (2609.27003), Banana Kick (2609.27269), DAVIS (2609.28175), ForgetMimic (2609.28378), TactileStep (2609.28959), Echo in the Steps (2609.28960).
- `04_loco_manip`: 7 entries — Learning Distance-Conditioned Object Transport for Humanoid Loco-Manipulation from a Single Motion Clip (2609.21467), FRAMES (2609.22538), Whole-Body UMI (2609.22829), STRIDER (2609.23483), Opt2VLA (2609.23968), HOTICE (2609.25363), Brace Yourself (2609.25486).
- `06_retarget_teleop`: 3 entries — MATE (2609.26520), Morphometric Imitation (2609.28660), BeyondRetarget (2609.29850).

### New Entries

#### Human-Object Interaction Motion Generation

- ⏳ 🤖 🧍 **[HIGenNTO: Scalable Humanoid Interaction Generation via Noise-Space Trajectory Optimization](https://arxiv.org/abs/2609.22611)** — `arXiv 2026.09` — Optimizes the initial noise of a pretrained text-conditioned motion model under contact, collision, support, and scene constraints to synthesize executable humanoid-scene interaction references.

#### Whole-Body Motion Tracking and Imitation

- ❌ 🤖 🧍 **[FootQuery: Future-Touchdown-Guided Retrieval from Depth History for Perceptive Humanoid Locomotion](https://arxiv.org/abs/2609.21447)** — `arXiv 2026.09` — Queries historical depth frames around predicted future touchdowns so a G1 can use terrain that is currently occluded or outside the latest camera view.
- 🌐 🤖 🧍 **[LIMBO: Learning and Internalizing Model-Free Barrier Objectives for Agile and Safe Whole-Body Control](https://arxiv.org/abs/2609.22075)** — `arXiv 2026.09` — Learns a state-action control-barrier certificate around a frozen base controller, then distills that safety structure into agile humanoid task policies.
- ❌ 🤖 🧍 **[EmoPose: Vision-Language Model Guided Emotion-Aware Gesture Generation for Humanoid Robots](https://arxiv.org/abs/2609.23414)** — `arXiv 2026.09` — Routes language, dialogue context, and visual cues through a structured VLM gesture plan that maps onto validated 14-DoF G1 joint trajectories.
- ❌ 🤖 🧍 **[UniPoint: Unified Point-Level Sensor Fusion for Humanoid Locomotion Across Challenging Terrains](https://arxiv.org/abs/2609.23666)** — `RA-L submission / arXiv 2026.09` — Early-fuses 360-degree LiDAR and dual depth-camera point tokens with proprioception to drive a single humanoid locomotion policy across heterogeneous terrain.
- ⭐ 🤖 🧍 **[Smoothness as a Constraint for Stable Humanoid Locomotion](https://arxiv.org/abs/2609.24552)** — `arXiv 2026.09` — Introduces DeCap, a constrained RL policy that separates upper- and lower-body smoothness limits instead of hiding smoothness inside reward weights.
- 🌐 🤖 🧍 **[PredActor: Predictive Action Diffusion for Steerable Onboard Humanoid Control](https://arxiv.org/abs/2609.24840)** — `arXiv 2026.09` — Jointly denoises executable actions and an internal future-state trajectory so a proprioceptive G1 policy can be steered by text and test-time objectives onboard.
- ❌ 🤖 🧍 **[PLAT: Sparse Timed Keyframe Motion Tracking for Humanoid Control via Privileged Latent Transition Learning](https://arxiv.org/abs/2609.25754)** — `arXiv 2026.09` — Learns a sparse timed-keyframe tracker by supervising latent transitions from dense expert motion and refining them with residual RL.
- ❌ 🤖 🧍 **[Sample, Simulate, Select: Physics-in-the-Loop Text-to-Motion for Humanoids Without Training](https://arxiv.org/abs/2609.26420)** — `arXiv 2026.09` — Samples text-to-motion candidates, retargets them to G1, simulates them with a pretrained SONIC tracker, and selects the most executable motion without new training.
- ❌ 🧍 🧱 **[Humanoid Locomotion with a Fly-Inspired Recurrent Controller](https://arxiv.org/abs/2609.27001)** — `arXiv 2026.09` — Couples 3,609 recurrent neural states to a simulated G1 and analyzes which state pathways actually support deployed locomotion behavior.
- 🧩 🤖 🧍 **[Learning Expressive Humanoid Locomotion from Monocular Runway Videos for Robot Fashion Shows](https://arxiv.org/abs/2609.27003)** — `IROS 2026 / arXiv 2026.09` — Converts monocular runway videos into retargeted, corrected, and trained humanoid catwalk policies deployed on a Booster K1.
- ❌ 🤖 🧍 **[Banana Kick: Response-Informed Skill Evolution for Humanoid Soccer](https://arxiv.org/abs/2609.27269)** — `arXiv 2026.09` — Evolves an ordinary humanoid kicking prior into a high-spin curved kick by adapting task objectives only when cached rollout responses show learnable progress.
- 🌐 🤖 🧍 **[DAVIS: A Depth-Only End-to-End Active-Vision Framework for Humanoid Soccer Skills](https://arxiv.org/abs/2609.28175)** — `arXiv 2026.09` — Learns depth-only end-to-end humanoid soccer skills that close the loop over perception, approach, impact, and recovery from head-mounted depth plus proprioception.
- ⏳ 🤖 🧍 **[ForgetMimic: Motion Unlearning for Reinforcement Learning Humanoid Control](https://arxiv.org/abs/2609.28378)** — `arXiv 2026.09` — Selectively degrades target motions in a multi-motion humanoid RL policy while preserving the remaining repertoire.
- ⏳ 🤖 🧍 **[TactileStep: Sole Tactile Learning for Regulating Foot-Terrain Interaction in Humanoid Locomotion](https://arxiv.org/abs/2609.28959)** — `CoRL 2026 / arXiv 2026.09` — Aligns simulated sole-pressure signals with real pressure insoles so humanoid policies can regulate touchdown force and stance contact area.
- ⏳ 🤖 🧍 **[Echo in the Steps: Learning Perceptive Humanoid Parkour with Gated Memory](https://arxiv.org/abs/2609.28960)** — `arXiv 2026.09` — Uses saliency-guided gated visual memory and gait alternation regularization to cross sparse footholds and narrow support regions from onboard depth.

#### Whole-Body Control and Loco-Manipulation

- ❌ 🤖 🧍 **[Learning Distance-Conditioned Object Transport for Humanoid Loco-Manipulation from a Single Motion Clip](https://arxiv.org/abs/2609.21467)** — `arXiv 2026.09` — Recombines a single retargeted transport clip into distance-conditioned references, then distills achieved object placements into a reference-free policy.
- ❌ 🧍 🧱 **[FRAMES: Failure Recovery And Monitoring of Embodied Skills for Humanoid Loco-Manipulation](https://arxiv.org/abs/2609.22538)** — `IROS 2026 Workshop / arXiv 2026.09` — Supervises parameterized G1 loco-manipulation skills with a planner, VLM monitor, recovery agent, semantic memory, and geometric grounding.
- ⏳ 🤖 🧍 **[Whole-Body UMI: Transferring UMI Manipulation Skills to Humanoid Whole-Body Manipulation via Real-Time Motion Generation](https://arxiv.org/abs/2609.22829)** — `arXiv 2026.09` — Transfers native UMI end-effector manipulation policies to whole-body humanoid execution through an asynchronous real-time motion generator and WBC layer.
- ❌ 🤖 🧍 **[STRIDER: Stepping-Enabled Multi-Gait Hierarchical 3D Loco-Manipulation Framework for Humanoid Robots](https://arxiv.org/abs/2609.23483)** — `ICRA 2027 submission / arXiv 2026.09` — Combines terrain-aware 3D stepping, AMP walking, and Cartesian upper-body control with latent-aligned distillation into one hardware-deployed humanoid policy.
- 🌐 🤖 🧍 **[Opt2VLA: Force-Aware Vision-Language-Action for Contact-Rich Humanoid Whole-Body Manipulation](https://arxiv.org/abs/2609.23968)** — `arXiv 2026.09` — Adds explicit force commands to the VLA-to-WBC interface and trains them from force-consistent whole-body trajectory optimization data.
- 🌐 🤖 🧍 **[HOTICE: Whole-Body Humanoid Object Transportation in Cluttered Environments](https://arxiv.org/abs/2609.25363)** — `arXiv 2026.09` — Coordinates robot-body and carried-object collision avoidance through decoupled potential fields and dual-agent upper/lower-body RL.
- ❌ 🤖 🧍 **[Brace Yourself: Task-Conditioned Environmental Bracing for Forceful Humanoid Manipulation](https://arxiv.org/abs/2609.25486)** — `RA-L submission / arXiv 2026.09` — Learns a task-conditioned support-hand bracing strategy that lets a G1 exert much larger manipulation forces while preserving balance.

#### Human-to-Humanoid Retargeting

- ⏳ 🤖 **[Morphometric Imitation: From Morphology and Contact Aware Hand Retargeting to Sim-to-Real Visuomotor Policy](https://arxiv.org/abs/2609.28660)** — `arXiv 2026.09` — Retargets reconstructed human hand-object interactions across robot hand morphologies, refines them with residual RL, and distills zero-shot visuomotor policies.
- ⭐ 🤖 🧍 **[BeyondRetarget: Learning Executable Humanoid Motions Directly from Monocular Video](https://arxiv.org/abs/2609.29850)** — `arXiv 2026.09` — Maps monocular RGB video directly into executable humanoid trajectories through a shared robot-oriented motion representation and robot-specific decoders.

#### Teleoperation and Demonstration Collection

- ⏳ 🤖 🧍 **[MATE: Multi-Agent Virtual Teleoperation Platform for Humanoid Collaboration Data Collection](https://arxiv.org/abs/2609.26520)** — `arXiv 2026.09` — Lets distributed operators teleoperate multiple whole-body humanoids in one physics environment and collects coordinated interaction demonstrations.

### Most Implementation-Ready Papers (verified official code)
- ⭐ **[AnyWorld: Factorized Egocentric World Models for Cross-Embodiment Generalization](https://arxiv.org/abs/2608.29242)** — `arXiv 2026.08` — Factorizes egocentric interaction data into action, camera, and embodiment controls to generate robot-native video-action rollouts and improve real IRON humanoid manipulation.
- ⭐ **[BeyondRetarget: Learning Executable Humanoid Motions Directly from Monocular Video](https://arxiv.org/abs/2609.29850)** — `arXiv 2026.09` — Maps monocular RGB video directly into executable humanoid trajectories through a shared robot-oriented motion representation and robot-specific decoders.
- ⭐ **[Closing the Loop on the Poppy Humanoid: Bipedal Locomotion with Linear-Quadratic Control and Learned Cost Functions](https://arxiv.org/abs/2608.26505)** — `arXiv 2026.08` — Learns an LQR cost function from open-loop Poppy walking data to close the control loop and improve reliable unassisted bipedal locomotion.
...
- ⭐ **[LAC: Linear and Angular Compliance for Humanoid Whole-body Control](https://arxiv.org/abs/2608.25405)** — `arXiv 2026.08` — Trains a single policy to realize commanded linear and angular compliance for upper-body wrenches while preserving whole-body humanoid stability.
...
- ⭐ **[LooperMuscle: Fast and Stable Learning of Humanoid Whole-Body Tracking via Structured Mixture-of-Experts](https://arxiv.org/abs/2608.00820)** — `arXiv 2026.08` — Uses a structured mixture-of-experts actor, expert-aware distributional critic, and contribution-routed replay to close the FastSAC-versus-PPO tracking-quality gap.
...
- ⭐ **[EMPIRE: Explicit Manipulation Planning as a Learnable Intermediate Representation for Egocentric Hand-Motion Forecasting](https://arxiv.org/abs/2608.22449)** — `arXiv 2026.08` — Uses explicit per-hand manipulation plans as a frozen intermediate representation before synthesizing future bimanual hand motions from egocentric observations.
- 🌐 **[HOIMask: Towards Generative Masked Modeling for Human Object Interaction Generation](https://arxiv.org/abs/2608.15141)** — `ECCV 2026 / arXiv 2026.08` — Replaces iterative diffusion with discrete masked modeling over contact-aware human and object token maps for text-driven HOI motion generation.
...
- 🌐 **[MAD-HOI: Masked Autoregressive Diffusion for Generating Articulated Hand Object Interactions from Text](https://arxiv.org/abs/2608.10162)** — `arXiv 2026.08` — Uses masked autoregression with a continuous diffusion/flow head to generate, complete, infill, and terminate articulated hand-object interaction sequences from text.
...
- 🌐 **[Surface Keypoint Representation for Multi-Object and Articulated Human-Object Interaction Generation](https://arxiv.org/abs/2608.03158)** — `arXiv 2026.08` — Represents object motion with surface keypoint trajectories and generates whole-body HOI for multi-object and articulated-object settings through contact-field guidance.
...
- ⏳ 🧍 🧱 **[LYRIC: Language-Driven Physics-Based Character Control for Contact-Rich Whole-Body Object Interaction](https://arxiv.org/abs/2609.19688)** — `arXiv 2026.09` — Uses a flow-matching planner and action generator to turn free-form language plus sparse object goals into closed-loop contact-rich whole-body object interactions.
...
- ⭐ 🤖 🧍 **[MOSAIC: Bridging the Sim-to-Real Gap in Generalist Humanoid Motion Tracking and Teleoperation with Rapid Residual Adaptation](https://arxiv.org/abs/2602.08594)** — `arXiv 2026.02` — Trains a generalist tracker then rapidly adapts to specific teleop interfaces via additive residuals.
- ⭐ 🤖 🧍 **[OASIS: From Simulation Data Collection to Real-World Humanoid Loco-Manipulation](https://arxiv.org/abs/2606.08548)** — `arXiv 2026.06` — Open simulation-to-real data pipeline for humanoid loco-manipulation with embodiment-aligned demonstrations.
- ⭐ 🤖 🧍 **[PAC-MAN: Perception-Aware CBF-RL for Whole-Body Safety in Humanoid Dodgeball](https://arxiv.org/abs/2607.28623)** — `arXiv 2026.07` — Couples control-barrier-function RL with onboard masked-depth perception so a G1 can dodge balls while maintaining whole-body link clearance.

---

_Total unique entries: **676**. Verified open-source: **242**._
...
- 🌐 **[HOIMask: Towards Generative Masked Modeling for Human Object Interaction Generation](https://arxiv.org/abs/2608.15141)** `ECCV 2026 / arXiv 2026.08` `human-object interaction synthesis` `HOI-Motion-Gen`
  Yihong Ji et al..
  Replaces iterative diffusion with discrete masked modeling over contact-aware human and object token maps for text-driven HOI motion generation.
  Links: [Project](https://jyhflash.github.io/HOIMask/) · [Paper](https://arxiv.org/abs/2608.15141)
...
- 🌐 **[MAD-HOI: Masked Autoregressive Diffusion for Generating Articulated Hand Object Interactions from Text](https://arxiv.org/abs/2608.10162)** `arXiv 2026.08` `hand-object interaction synthesis` `HOI-Motion-Gen`
  Ananya Bal et al..
  Uses masked autoregression with a continuous diffusion/flow head to generate, complete, infill, and terminate articulated hand-object interaction sequences from text.
  Links: [Project](https://ananyabal.github.io/MAD-HOI_supplementary_3D_visualizations/visualize_hoi_motions.html) · [Paper](https://arxiv.org/abs/2608.10162)
...
- 🌐 **[Surface Keypoint Representation for Multi-Object and Articulated Human-Object Interaction Generation](https://arxiv.org/abs/2608.03158)** `arXiv 2026.08` `human-object interaction synthesis` `HOI-Motion-Gen`
  Xiaogang Peng et al..
  Represents object motion with surface keypoint trajectories and generates whole-body HOI for multi-object and articulated-object settings through contact-field guidance.
  Links: [Project](https://neu-vi.github.io/SK-HOI/) · [Paper](https://arxiv.org/abs/2608.03158)
...
- ⏳ 🤖 🧍 **[HIGenNTO: Scalable Humanoid Interaction Generation via Noise-Space Trajectory Optimization](https://arxiv.org/abs/2609.22611)** `arXiv 2026.09` `Unitree G1 / humanoid interaction scenes` `HOI-Motion-Gen`
  Lalit Jayanti et al..
  Optimizes the initial noise of a pretrained text-conditioned motion model under contact, collision, support, and scene constraints to synthesize executable humanoid-scene interaction references.
  Links: [Project](https://higennto.github.io/) · [Paper](https://arxiv.org/abs/2609.22611)
...
- ⏳ 🧍 🧱 **[LYRIC: Language-Driven Physics-Based Character Control for Contact-Rich Whole-Body Object Interaction](https://arxiv.org/abs/2609.19688)** `arXiv 2026.09` `simulated humanoid characters` `HOI-Motion-Gen`
  Zeyu Han et al..
  Uses a flow-matching planner and action generator to turn free-form language plus sparse object goals into closed-loop contact-rich whole-body object interactions.
  Links: [Project](https://neu-vi.github.io/LYRIC/) · [Paper](https://arxiv.org/abs/2609.19688)

- ⏳ 🧍 **[ReCHOIR: Contact-guided Human Object Interaction Retargeting to Diverse Characters](https://arxiv.org/abs/2609.10982)** `SIGGRAPH Asia 2026 / arXiv 2026.09` `humanoid character interaction retargeting` `HOI-Motion-Gen`
  Chaelin Kim et al..
  Retargets human-object interaction sequences to humanoid characters with different skeletons while preserving object motion, contact cues, and interaction semantics.
  Links: [Project](https://cherry-leki.github.io/projects/ReCHOIR/) · [Paper](https://arxiv.org/abs/2609.10982)
...
- ❌ **[PhotoHOI: Synthesizing 3D Hand-Object Interactions from a Single RGB Photograph](https://arxiv.org/abs/2608.01905)** `arXiv 2026.08` `hand-object interaction synthesis` `HOI-Motion-Gen`
  Zhenhao Zhang et al..
  Synthesizes 3D hand-object interaction sequences from one RGB photograph and an open-vocabulary instruction by planning object motion and contact-conditioned hand motion.
  Links: [Paper](https://arxiv.org/abs/2608.01905)
...
| 2026 | [EMPIRE: Explicit Manipulation Planning as a Learnable Interm](https://arxiv.org/abs/2608.22449) | hand-object interaction forecasting | — | ⭐ Code | Uses explicit per-hand manipulation plans as a frozen intermediate representatio |
| 2026 | [HOIMask: Towards Generative Masked Modeling for Human Object](https://arxiv.org/abs/2608.15141) | human-object interaction synthesis | — | 🌐 Project Page | Replaces iterative diffusion with discrete masked modeling over contact-aware hu |
...
| 2026 | [MAD-HOI: Masked Autoregressive Diffusion for Generating Arti](https://arxiv.org/abs/2608.10162) | hand-object interaction synthesis | — | 🌐 Project Page | Uses masked autoregression with a continuous diffusion/flow head to generate, co |
...
| 2026 | [Surface Keypoint Representation for Multi-Object and Articul](https://arxiv.org/abs/2608.03158) | human-object interaction synthesis | — | 🌐 Project Page | Represents object motion with surface keypoint trajectories and generates whole- |
...
| 2026 | [HIGenNTO: Scalable Humanoid Interaction Generation via Noise](https://arxiv.org/abs/2609.22611) | Unitree G1 / humanoid interaction scenes | ✅ | ⏳ Code Coming Soon | Optimizes the initial noise of a pretrained text-conditioned motion model under  |
...
| 2026 | [LYRIC: Language-Driven Physics-Based Character Control for C](https://arxiv.org/abs/2609.19688) | simulated humanoid characters | — | ⏳ Code Coming Soon | Uses a flow-matching planner and action generator to turn free-form language plu |
| 2026 | [ReCHOIR: Contact-guided Human Object Interaction Retargeting](https://arxiv.org/abs/2609.10982) | humanoid character interaction retargeting | — | ⏳ Code Coming Soon | Retargets human-object interaction sequences to humanoid characters with differe |
...
- 🧩 🤖 🧍 **[Learning Expressive Humanoid Locomotion from Monocular Runway Videos for Robot Fashion Shows](https://arxiv.org/abs/2609.27003)** `IROS 2026 / arXiv 2026.09` `Booster K1 humanoid` `WBC`
  Kyrylo Kolesnichenko et al..
  Converts monocular runway videos into retargeted, corrected, and trained humanoid catwalk policies deployed on a Booster K1.
  Links: [Code](https://github.com/BoosterRobotics/booster_train) · [Paper](https://arxiv.org/abs/2609.27003) · [Dataset](https://github.com/BoosterRobotics/booster_deploy)

- 🧩 🧍 🧱 **[Demonstration-Guided Humanoid Stand-Up on an Emulated Deformable Surface](https://arxiv.org/abs/2608.20852)** `arXiv 2026.08` `Unitree G1` `WBC`
  Aniruddh Kushwah et al..
  Adapts a reference-guided PPO stand-up policy from hard ground to emulated compliant terrain using MuJoCo soft-contact parameters.
  Links: [Project](https://github.com/andireposit/Stand-Up-Motion-on-Compliant-Surface-for-Humanoid) · [Code](https://github.com/andireposit/Stand-Up-Motion-on-Compliant-Surface-for-Humanoid) · [Paper](https://arxiv.org/abs/2608.20852)

- 🧩 🧍 🧱 **[Natural Sit-to-Stand Motion Synthesis For Humanoids via Guided Assistance Curricula and Staged Rewards](https://arxiv.org/abs/2608.20823)** `arXiv 2026.08` `Unitree G1` `WBC`
  Meet Pal Singh et al..
  Synthesizes smooth Unitree G1 sit-to-stand motions from scratch using a decaying assistance curriculum, IK pose sampling, and staged balance rewards.
  Links: [Project](https://github.com/meetpal644/Sit-to-Stand-Motion-Synthesis-For-Humanoids) · [Code](https://github.com/meetpal644/Sit-to-Stand-Motion-Synthesis-For-Humanoids) · [Paper](https://arxiv.org/abs/2608.20823)

- 📦 🤖 🧍 **[First Deployable Dynamic-CoM: A Unified Policy and Method-Agnostic Benchmark for Humanoid Single-Leg Balance](https://arxiv.org/abs/2608.00500)** `arXiv 2026.08` `Unitree G1` `WBC`
  Yikai Zhou et al..
  Introduces a deployable support-relative dynamic-CoM observation and benchmark for clean single-leg humanoid balance on real Unitree G1 hardware.
  Links: [Paper](https://arxiv.org/abs/2608.00500) · [Dataset](https://huggingface.co/datasets/zhouyikai/FDDC-single-leg-balance)
...
- 🌐 🤖 🧍 **[BRIDGE: An Open-Source Humanoid Platform via Morphology-Control Co-Design for Physical AI](https://arxiv.org/abs/2609.03497)** `arXiv 2026.09` `Bridge 88cm humanoid` `WBC`
  Jianren Wang et al..
  Co-designs a small open humanoid morphology against retargeting fidelity and dynamic tracking metrics, then demonstrates locomotion, balance, and dynamic maneuvers on the Bridge platform.
  Links: [Project](https://sites.google.com/view/bridgerobot) · [Paper](https://arxiv.org/abs/2609.03497)

- 🌐 🤖 🧍 **[DAVIS: A Depth-Only End-to-End Active-Vision Framework for Humanoid Soccer Skills](https://arxiv.org/abs/2609.28175)** `arXiv 2026.09` `Noetix E1 humanoid` `WBC`
  Jiakang Jin et al..
  Learns depth-only end-to-end humanoid soccer skills that close the loop over perception, approach, impact, and recovery from head-mounted depth plus proprioception.
  Links: [Project](https://thusi-lab.github.io/DAVIS/) · [Paper](https://arxiv.org/abs/2609.28175)
...
- 🌐 🤖 🧍 **[Humanoid Safe Stop via Learned Stoppability Value](https://arxiv.org/abs/2609.02358)** `arXiv 2026.09` `humanoid` `WBC`
  Junfeng Long et al..
  Learns complementary stop-probability and reach-avoidance value estimators that decide whether an emergency stop is recoverable or should hand off to a fallback.
  Links: [Project](https://junfeng-long.github.io/safestop/) · [Paper](https://arxiv.org/abs/2609.02358)
...
- 🌐 🤖 🧍 **[Learning Agile Perceptive Traversal of Sparse 3D Structures for Humanoids](https://arxiv.org/abs/2608.29769)** `arXiv 2026.08` `humanoid with passive hook end-effectors` `WBC`
  Efe Ongan et al..
  Trains a lidar-conditioned policy through a phase-scheduled teacher-student pipeline for jump-up, brachiation, and jump-down traversal of sparse overhead structures.
  Links: [Project](https://nemantor.github.io/sparse-3d-traversal-website/) · [Paper](https://arxiv.org/abs/2608.29769)

- 🌐 🤖 🧍 **[Learning Safe Humanoid Navigation from Reduced Order Models](https://arxiv.org/abs/2609.19272)** `ICRA 2027 submission / arXiv 2026.09` `Unitree G1` `WBC`
  William D. Compton et al..
  Transfers navigation knowledge from reduced-order dynamics into full-order G1 navigation with a frozen locomotion policy and a Poisson safety filter for OOD obstacles.
  Links: [Project](https://wdc3iii.github.io/rom-nav/) · [Paper](https://arxiv.org/abs/2609.19272)

- 🌐 🤖 🧍 **[LIMBO: Learning and Internalizing Model-Free Barrier Objectives for Agile and Safe Whole-Body Control](https://arxiv.org/abs/2609.22075)** `arXiv 2026.09` `29-DoF humanoid` `WBC`
  Jake Gonzales et al..
  Learns a state-action control-barrier certificate around a frozen base controller, then distills that safety structure into agile humanoid task policies.
  Links: [Project](https://www.max-robotics.com/en/research/publications/cmuba8yjj0005mt42m7wu2goo) · [Paper](https://arxiv.org/abs/2609.22075)
...
- 🌐 🤖 🧍 **[PGMT: Perceptive General Motion Tracking for Humanoid Robots](https://arxiv.org/abs/2609.08511)** `arXiv 2026.09` `Unitree G1` `WBC`
  Hongyi Li et al..
  Extends general humanoid motion tracking with motion-conditioned terrain glimpses and relaxed terrain-aware tracking for uneven real-world terrain.
  Links: [Project](https://luyili.github.io/pgmt/) · [Paper](https://arxiv.org/abs/2609.08511)

- 🌐 🤖 🧍 **[PredActor: Predictive Action Diffusion for Steerable Onboard Humanoid Control](https://arxiv.org/abs/2609.24840)** `arXiv 2026.09` `Unitree G1` `WBC`
  Lei Ye et al..
  Jointly denoises executable actions and an internal future-state trajectory so a proprioceptive G1 policy can be steered by text and test-time objectives onboard.
  Links: [Project](https://masteryip.github.io/predactor.github.io/) · [Paper](https://arxiv.org/abs/2609.24840)
...
- 🌐 🤖 🧍 **[SOLO: Stable Omni-terrain Long-Horizon Perceptive Humanoid Locomotion](https://arxiv.org/abs/2608.26583)** `arXiv 2026.08` `humanoid with chest-mounted depth camera` `WBC`
  Pihai Sun et al..
  Combines query-based terrain reconstruction with trajectory-aware distillation so a depth-conditioned humanoid locomotion policy remains stable over long outdoor traversals.
  Links: [Project](https://sunpihai-up.github.io/solo/) · [Paper](https://arxiv.org/abs/2608.26583)

- 🌐 🤖 🧍 **[SwingBot: Learning Whole-Body Brachiation for Humanoid Robots](https://arxiv.org/abs/2609.10283)** `CoRL 2026 / arXiv 2026.09` `high-DoF humanoid with passive wrist hooks` `WBC`
  Yujie Xiong et al..
  Learns continuous humanoid brachiation by structuring exploration around release-swing-capture keyframes and recurrent latent estimation for hook contact.
  Links: [Project](https://ttbray.github.io/SwingBot/) · [Paper](https://arxiv.org/abs/2609.10283)

- 🌐 🤖 🧍 **[TANGO: Humanoid Navigation in Cluttered Environments with a Whole-Body Vision-Language-Action Model](https://arxiv.org/abs/2609.09158)** `arXiv 2026.09` `Unitree G1` `WBC`
  Anqi Li et al..
  Predicts 29-DoF whole-body actions from language and egocentric RGB so a G1 can traverse cluttered indoor scenes rather than plan only 2D paths.
  Links: [Project](https://tango-vla.github.io/tango-vla.github.io) · [Paper](https://arxiv.org/abs/2609.09158)
...
- 🌐 🧍 🧱 **[SCRIPT: Scalable Diffusion Policy with Multi-stage Training for Language-driven Physics-based Humanoid Control](https://arxiv.org/abs/2605.22894)** `arXiv 2026.05 (v3 Sep 2026)` `physics-based humanoid` `Motion-Imitation`
  Jingyan Zhang et al..
...
- ⏳ 🤖 🧍 **[ADAPT: Agile Diffusion Action Priors for Robust and Steerable Online Text-Driven Humanoid Control](https://arxiv.org/abs/2609.00677)** `arXiv 2026.09` `Unitree G1` `WBC`
  Yan Wu et al..
  Uses a text-conditioned diffusion action prior plus lightweight residual RL to execute robust 50 Hz humanoid whole-body skills under online prompt switching.
  Links: [Project](https://wuyan01.github.io/ADAPT-project/) · [Paper](https://arxiv.org/abs/2609.00677)
...
- ⏳ 🤖 🧍 **[CAP: Continuously Adaptive Perception-Blind Humanoid Locomotion via Learned Denoising](https://arxiv.org/abs/2609.11553)** `CoRL 2026 / arXiv 2026.09` `Unitree G1` `WBC`
  Hongjin Chen et al..
  Trains a single G1 locomotion policy whose world-model encoder denoises corrupted depth while a proprioceptive pathway keeps control stable when perception degrades.
  Links: [Project](https://hoshi-no-ai.github.io/CAP/) · [Code](https://github.com/Hoshi-No-Ai/CAP) · [Paper](https://arxiv.org/abs/2609.11553)

- ⏳ 🤖 🧍 **[Echo in the Steps: Learning Perceptive Humanoid Parkour with Gated Memory](https://arxiv.org/abs/2609.28960)** `arXiv 2026.09` `humanoid` `WBC`
  Ming-Ju Lee et al..
  Uses saliency-guided gated visual memory and gait alternation regularization to cross sparse footholds and narrow support regions from onboard depth.
  Links: [Project](https://echo-in-the-steps.github.io/) · [Paper](https://arxiv.org/abs/2609.28960)

- ⏳ 🤖 🧍 **[ForgetMimic: Motion Unlearning for Reinforcement Learning Humanoid Control](https://arxiv.org/abs/2609.28378)** `arXiv 2026.09` `Unitree G1 / H2 humanoids` `WBC`
  Xukun Luan et al..
  Selectively degrades target motions in a multi-motion humanoid RL policy while preserving the remaining repertoire.
  Links: [Code](https://github.com/Zili1000/ForgetMimic) · [Paper](https://arxiv.org/abs/2609.28378)

- ⏳ 🤖 🧍 **[GigaBrain-WBC-0.5: A Behavior World Model for Robust Humanoid Whole-Body Tracking with Environment Interaction](https://arxiv.org/abs/2608.18234)** `arXiv 2026.08` `Unitree G1 / Maker L01` `WBC`
  Ziyang Cheng et al..
  Trains a causal behavior world model that predicts actions, proprioceptive futures, and feasible latent behavior commands for environment-aware WBC.
  Links: [Project](https://shepherd1226.github.io/gigabrain-wbc-0.5/) · [Paper](https://arxiv.org/abs/2608.18234)

- ⏳ 🤖 🧍 **[GM-Loco: Terrain-Adaptive Humanoid Locomotion on Granular Media](https://arxiv.org/abs/2609.10286)** `arXiv 2026.09` `humanoid` `WBC`
  Junnosuke Kamohara et al..
  Combines a 3D resistive-force granular contact model with teacher-student RL so humanoid locomotion policies adapt across sand, basalt, and beach terrain.
  Links: [Project](https://humanoid-gm-locomotion.github.io/HUMANOID-GM/) · [Paper](https://arxiv.org/abs/2609.10286)
...
- ⏳ 🤖 🧍 **[Tac4Loco: Learning Spatiotemporal Plantar Pressure Representations for Humanoid Locomotion](https://arxiv.org/abs/2608.15766)** `arXiv 2026.08` `humanoid / Unitree G1-class platforms` `WBC`
  Ziyun Liu et al..
  Uses topology-preserving plantar-pressure features as direct post-contact feedback for humanoid locomotion over uncertain support.
  Links: [Paper](https://arxiv.org/abs/2608.15766)

- ⏳ 🤖 🧍 **[TactileStep: Sole Tactile Learning for Regulating Foot-Terrain Interaction in Humanoid Locomotion](https://arxiv.org/abs/2609.28959)** `CoRL 2026 / arXiv 2026.09` `Unitree G1` `WBC`
  Zizhuo Wang et al..
  Aligns simulated sole-pressure signals with real pressure insoles so humanoid policies can regulate touchdown force and stance contact area.
  Links: [Project](https://tactilestep.github.io/) · [Paper](https://arxiv.org/abs/2609.28959)

- ⏳ 🤖 🧍 **[ViBe: Visual Behavior Adaptation for Perceptive Humanoid Whole-Body Control](https://arxiv.org/abs/2609.09918)** `arXiv 2026.09` `humanoid whole-body trackers` `WBC`
  Lokesh Krishna et al..
  Post-trains humanoid motion trackers for visual tasks by grafting pretrained visual features into the tracker through parameter-efficient adapters.
  Links: [Project](https://lok-i.github.io/vibe-control/) · [Code](https://github.com/lok-i/vibe) · [Paper](https://arxiv.org/abs/2609.09918)

- ⏳ 🧍 🧱 **[Learning Context-Aware Motion Priors for Humanoid Control](https://arxiv.org/abs/2608.03234)** `arXiv 2026.08` `humanoid control benchmarks` `WBC`
  Yunyang Mo et al..
  Learns context-motion compatibility from high-advantage rollouts and reweights motion-prior supervision for the current humanoid control task.
  Links: [Paper](https://arxiv.org/abs/2608.03234)
...
- ❌ 🤖 🧍 **[Banana Kick: Response-Informed Skill Evolution for Humanoid Soccer](https://arxiv.org/abs/2609.27269)** `arXiv 2026.09` `humanoid soccer robot` `WBC`
  Hao E. Zhang et al..
  Evolves an ordinary humanoid kicking prior into a high-spin curved kick by adapting task objectives only when cached rollout responses show learnable progress.
  Links: [Project](https://haozhang-thu.github.io/bananakick/) · [Paper](https://arxiv.org/abs/2609.27269)
...
- ❌ 🤖 🧍 **[Collision-Aware Humanoid Whole-Body Control under Imperfect Tracking Targets](https://arxiv.org/abs/2609.16405)** `Humanoids 2026 submission / arXiv 2026.09` `Digit V3` `WBC`
  Mohitvishnu S. Gadde et al..
  Wraps blind WBC trackers with RECAL, a robot-environment cross-attention layer that trades target tracking against scene and held-object collision avoidance.
  Links: [Paper](https://arxiv.org/abs/2609.16405)
...
- ❌ 🤖 🧍 **[DWMP: Leveraging Dual World Models for Humanoid Obstacle Traversal](https://arxiv.org/abs/2609.12347)** `arXiv 2026.09` `Unitree G1` `WBC`
  Rongjun Jin et al..
  Fuses a Koopman proprioceptive dynamics world model with an RSSM visual world model so a G1 can traverse randomized obstacle fields from onboard observations.
  Links: [Paper](https://arxiv.org/abs/2609.12347)
...
- ❌ 🤖 🧍 **[EmoPose: Vision-Language Model Guided Emotion-Aware Gesture Generation for Humanoid Robots](https://arxiv.org/abs/2609.23414)** `arXiv 2026.09` `Unitree G1` `WBC`
  Daojie Peng et al..
  Routes language, dialogue context, and visual cues through a structured VLM gesture plan that maps onto validated 14-DoF G1 joint trajectories.
  Links: [Paper](https://arxiv.org/abs/2609.23414)

- ❌ 🤖 🧍 **[FootQuery: Future-Touchdown-Guided Retrieval from Depth History for Perceptive Humanoid Locomotion](https://arxiv.org/abs/2609.21447)** `arXiv 2026.09` `Unitree G1` `WBC`
  Tao Dong et al..
  Queries historical depth frames around predicted future touchdowns so a G1 can use terrain that is currently occluded or outside the latest camera view.
  Links: [Paper](https://arxiv.org/abs/2609.21447)
...
- ❌ 🤖 🧍 **[Learning Slope-Adaptive Whole-Body Locomotion for Humanoid Robots in Roofing Construction](https://arxiv.org/abs/2609.20558)** `arXiv 2026.09` `Unitree G1` `WBC`
  Songyang Liu et al..
  Grounds retargeted human roofer motions to metric roof geometry and trains G1 policies that preserve support and work-clearance relations across sloped construction tasks.
  Links: [Paper](https://arxiv.org/abs/2609.20558)
...
- ❌ 🤖 🧍 **[PAMoR: Parameterized Affective Motion Generation in Real Time for Humanoid Robots](https://arxiv.org/abs/2608.28213)** `arXiv 2026.08` `Unitree G1` `WBC`
  Yan Pan et al..
  Composes action and affect priors in a shared latent space to generate editable valence-arousal-conditioned whole-body G1 motions in real time.
  Links: [Paper](https://arxiv.org/abs/2608.28213)

- ❌ 🤖 🧍 **[PASSAGE: Scaling Scene-Aligned Motion Learning for Perceptive Humanoid Traversal in Cluttered Environments](https://arxiv.org/abs/2609.18732)** `arXiv 2026.09` `humanoid with onboard Jetson AGX Orin` `WBC`
  Yuxuan Ma et al..
  Scales a planner-tracker stack with 100 hours of scene-aligned human motion so a humanoid can step over, squeeze past, and duck under clutter using onboard 3D perception.
  Links: [Paper](https://arxiv.org/abs/2609.18732)
...
- ❌ 🤖 🧍 **[PLAT: Sparse Timed Keyframe Motion Tracking for Humanoid Control via Privileged Latent Transition Learning](https://arxiv.org/abs/2609.25754)** `arXiv 2026.09` `Unitree G1` `WBC`
  Zepeng Wang et al..
  Learns a sparse timed-keyframe tracker by supervising latent transitions from dense expert motion and refining them with residual RL.
  Links: [Paper](https://arxiv.org/abs/2609.25754)
...
- ❌ 🤖 🧍 **[RoboDreamer: Anticipatory Humanoid Locomotion with Predictive State-Space Models](https://arxiv.org/abs/2609.07096)** `arXiv 2026.09` `Unitree G1` `WBC`
  Zhe Li et al..
  Distills clean-observation locomotion teachers into a temporal state-space student that infers masked observations from history and refines actions at inference time.
  Links: [Paper](https://arxiv.org/abs/2609.07096)
...
- ❌ 🤖 🧍 **[Sample, Simulate, Select: Physics-in-the-Loop Text-to-Motion for Humanoids Without Training](https://arxiv.org/abs/2609.26420)** `arXiv 2026.09` `Unitree G1` `WBC`
  Raphael Memmesheimer et al..
  Samples text-to-motion candidates, retargets them to G1, simulates them with a pretrained SONIC tracker, and selects the most executable motion without new training.
  Links: [Paper](https://arxiv.org/abs/2609.26420)

- ❌ 🤖 🧍 **[StableMimic: Smooth Human-Like Recovery for Humanoid Motion Tracking](https://arxiv.org/abs/2608.02385)** `arXiv 2026.08` `Unitree G1` `WBC`
  Weihao Wu et al..
  Blends tracking and recovery experts with a proprioceptive gate so a humanoid can recover from low-height fall states and resume reference tracking.
  Links: [Paper](https://arxiv.org/abs/2608.02385)

- ❌ 🤖 🧍 **[Throwing a Tight Spiral American Football by a Humanoid Robot](https://arxiv.org/abs/2608.16642)** `arXiv 2026.08` `Unitree G1 + Dex3-1 gripper` `WBC`
  Zaid Mahboob et al..
  Coordinates lower-body stabilization, upper-body throw tracking, and MPC follow-through to produce spin-stabilized football throws on a G1.
  Links: [Paper](https://arxiv.org/abs/2608.16642)

- ❌ 🤖 🧍 **[UniPoint: Unified Point-Level Sensor Fusion for Humanoid Locomotion Across Challenging Terrains](https://arxiv.org/abs/2609.23666)** `RA-L submission / arXiv 2026.09` `DR02 humanoid` `WBC`
  Sicen Li et al..
  Early-fuses 360-degree LiDAR and dual depth-camera point tokens with proprioception to drive a single humanoid locomotion policy across heterogeneous terrain.
  Links: [Paper](https://arxiv.org/abs/2609.23666)

- ❌ 🤖 🧍 **[World-Model-Augmented Visual Locomotion for Humanoids on Foothold-Constrained Terrain](https://arxiv.org/abs/2609.02542)** `arXiv 2026.09` `Unitree G1` `WBC`
  Yuxi Liu et al..
  Trains a recurrent world model with a PPO depth-conditioned locomotion policy so a G1 can anticipate gaps, stepping stones, and narrow stairs from onboard perception.
  Links: [Paper](https://arxiv.org/abs/2609.02542)
...
- ❌ 🧍 🧱 **[EMoG: Emotion-Modulated Gait Generation for Expressive Humanoid Locomotion](https://arxiv.org/abs/2609.14432)** `arXiv 2026.09` `humanoid` `WBC`
  Yi Lu et al..
  Generates command-consistent humanoid gait trajectories from continuous emotion/style codes and tracks them with a unified RL locomotion policy.
  Links: [Paper](https://arxiv.org/abs/2609.14432)

- ❌ 🧍 🧱 **[Flow-Matched Motion Priors: Online Optimal-Transport Rewards for Imitation Learning](https://arxiv.org/abs/2609.15631)** `arXiv 2026.09` `Unitree G1` `Motion-Imitation`
  Yilin Zou et al..
  Learns scalar imitation rewards from flow-matched optimal-transport paths between current rollouts and expert motion histories, improving G1 walking stability over AMP-style rewards.
  Links: [Paper](https://arxiv.org/abs/2609.15631)

- ❌ 🧍 🧱 **[GenTrack: Physical Alignment for Robot-Native Motion Generation and Zero-Shot Humanoid Tracking](https://arxiv.org/abs/2608.01410)** `arXiv 2026.08` `Unitree G1` `WBC`
  Zeyu Ling et al..
  Alternates text-to-motion generator alignment with tracker training so generated references become more robot-executable for zero-shot humanoid tracking.
  Links: [Paper](https://arxiv.org/abs/2608.01410)
...
- ❌ 🧍 🧱 **[Humanoid Locomotion with a Fly-Inspired Recurrent Controller](https://arxiv.org/abs/2609.27001)** `arXiv 2026.09` `simulated Unitree G1` `WBC`
  Isabel Guan et al..
  Couples 3,609 recurrent neural states to a simulated G1 and analyzes which state pathways actually support deployed locomotion behavior.
  Links: [Paper](https://arxiv.org/abs/2609.27001)
...
- ❌ 🧍 🧱 **[PFM-HR: Pose Flow Matching for Humanoid Robots](https://arxiv.org/abs/2608.03227)** `arXiv 2026.08` `humanoid tracking benchmarks` `WBC`
  Yukang Gao et al..
  Trains a reusable flow-matching pose prior from unordered pose data and uses a Pose Geometry Score to reward structured pose transitions during tracking.
  Links: [Paper](https://arxiv.org/abs/2608.03227)
...
- ❌ 🧍 🧱 **[ResSafe: Learning Safety Filtering with Residual Reinforcement Learning for Humanoids](https://arxiv.org/abs/2609.15988)** `arXiv 2026.09` `humanoid` `WBC`
  Gechen Qu et al..
  Decouples task performance and safety by training a residual policy that corrects unsafe nominal humanoid-control actions before they cause instability or falls.
  Links: [Paper](https://arxiv.org/abs/2609.15988)
...
- ❌ **[Thor: Towards Human-Inspired Whole-Body Reactions for Intense Contact-Rich Environments](https://arxiv.org/abs/2510.26280)** `arXiv 2025.10` `WBC-Tracking`
...
| Year | Paper | Robot/Data | Real Robot | Code | Key Idea |
|---|---|---|---|---|---|
| 2026 | [Closing the Loop on the Poppy Humanoid: Bipedal Locomotion w](https://arxiv.org/abs/2608.26505) | Poppy Humanoid | ✅ | ⭐ Code | Learns an LQR cost function from open-loop Poppy walking data to close the contr |
...
| 2026 | [LooperMuscle: Fast and Stable Learning of Humanoid Whole-Bod](https://arxiv.org/abs/2608.00820) | Holosoma runtime / humanoid | ✅ | ⭐ Code | Uses a structured mixture-of-experts actor, expert-aware distributional critic,  |
...
| 2026 | [RoboStriker: Latent-Space Strategic Games for Autonomous Hum](https://arxiv.org/abs/2608.16195) | humanoid robots / Unitree G1 | ✅ | ⭐ Code | Constrains two-player self-play for humanoid boxing to a learned motion-latent m |
...
| 2026 | [Smoothness as a Constraint for Stable Humanoid Locomotion](https://arxiv.org/abs/2609.24552) | Unitree G1 | ✅ | ⭐ Code | Introduces DeCap, a constrained RL policy that separates upper- and lower-body s |
...
| 2026 | [Towards Professional Tennis Styles for Humanoid Robots with ](https://arxiv.org/abs/2608.20087) | Unitree G1 / Dobot Atom | ✅ | ⭐ Code | AdaPT learns tennis serving and rally styles from broadcast video, then adapts p |
...
- 🌐 🤖 🧍 **[A System for Fast, Resilient, and Adaptable Loco-Manipulation Behaviors on Humanoid Robots](https://arxiv.org/abs/2609.01518)** `arXiv 2026.09 / PhD dissertation lineage` `Atlas, Valkyrie, Nadia, Unitree H1-2, Alex` `Loco-Manipulation`
  Duncan Calvert et al..
  Combines object-centric affordance templates, behavior trees, runtime-editable perception, and WBC primitives into a robot-local system for fast humanoid task authoring.
  Links: [Project](https://www.youtube.com/playlist?list=PLJK5CTyotYqsfgfnXb-09YNFeBose6uEY) · [Code](https://github.com/ihmcrobotics) · [Paper](https://arxiv.org/abs/2609.01518)

- 🌐 🤖 🧍 **[Blind Dexterity: Whole-Body Humanoid Manipulation via Pure Proprioception](https://arxiv.org/abs/2608.29487)** `arXiv 2026.08` `Unitree G1` `Loco-Manipulation`
  Aditya Bhatt et al..
  Trains G1 whole-body manipulation policies that infer object state from proprioceptive contact histories alone across walking, ball trapping, suitcase lifting, and skateboard mounting.
  Links: [Project](https://rclab.kookmin.ac.kr/project1/humanoid-robot-rok-3) · [Paper](https://arxiv.org/abs/2608.29487)
...
- 🌐 🤖 🧍 **[GOLEM: Modular Humanoid Autonomy Towards Electric Vehicle Battery Disassembly](https://arxiv.org/abs/2608.21550)** `arXiv 2026.08` `Unitree H1-2` `Loco-Manipulation`
  Max Conway et al..
  Organizes navigation, manipulation, standing control, digital twins, and spatial memory as interchangeable modules for humanoid EV battery disassembly.
  Links: [Project](https://golem-humanoid.github.io) · [Paper](https://arxiv.org/abs/2608.21550)
...
- 🌐 🤖 🧍 **[HOTICE: Whole-Body Humanoid Object Transportation in Cluttered Environments](https://arxiv.org/abs/2609.25363)** `arXiv 2026.09` `Unitree G1` `Loco-Manipulation`
  Toan Nguyen et al..
  Coordinates robot-body and carried-object collision avoidance through decoupled potential fields and dual-agent upper/lower-body RL.
  Links: [Project](https://hotice2027.github.io/) · [Paper](https://arxiv.org/abs/2609.25363)
...
- 🌐 🤖 🧍 **[Learning Loco-Manipulation From SMPC Demonstrations With Sparse Offline-to-Online RL](https://arxiv.org/abs/2608.12063)** `arXiv 2026.08` `Unitree G1 / arm-equipped Spot` `Loco-Manipulation`
  Martin Schuck et al..
  Uses sample-based MPC demonstrations to bootstrap sparse-reward offline-to-online RL for loco-manipulation skills deployed on Spot and G1.
  Links: [Project](https://pages.rai-inst.com/smpc2rl/) · [Paper](https://arxiv.org/abs/2608.12063)

- 🌐 🤖 🧍 **[Light-Loco-Parkour: Versatile Perceptive Whole-Body Locomotion via Multi-Skill Distillation](https://arxiv.org/abs/2608.02653)** `arXiv 2026.08` `humanoid` `Loco-Manipulation`
  Hongming Chen et al..
  Distills terrain-conditioned whole-body traversal skills into a single depth-conditioned humanoid locomotion policy for walking, balancing, climbing, stepping down, and vaulting.
  Links: [Project](https://light-loco-parkour.github.io/) · [Paper](https://arxiv.org/abs/2608.02653)

- 🌐 🤖 🧍 **[Opt2VLA: Force-Aware Vision-Language-Action for Contact-Rich Humanoid Whole-Body Manipulation](https://arxiv.org/abs/2609.23968)** `arXiv 2026.09` `humanoid` `Loco-Manipulation`
  Fukang Liu et al..
  Adds explicit force commands to the VLA-to-WBC interface and trains them from force-consistent whole-body trajectory optimization data.
  Links: [Project](https://opt2vla.github.io/) · [Paper](https://arxiv.org/abs/2609.23968)
...
- 🌐 🤖 🧍 **[SkillX: Unified Multi-Skill Policy Learning for Humanoid Soccer](https://arxiv.org/abs/2609.06718)** `CoRL 2026 / arXiv 2026.09` `Noetix E1 humanoid` `Loco-Manipulation`
  Zhangchen Ye et al..
  Learns a single command-conditioned humanoid soccer policy that composes dribbling, trapping, shooting, and transitions through skill-specific priors and critics.
  Links: [Project](https://yzc0731.github.io/SkillX/) · [Paper](https://arxiv.org/abs/2609.06718)
...
- 🌐 🤖 🧍 **[ViLoMan: Learning Visual-Proprioceptive Whole-Body Loco-Manipulation Skills for Humanoid Robots](https://arxiv.org/abs/2609.19340)** `arXiv 2026.09` `Unitree G1` `Loco-Manipulation`
  Zejie Tian et al..
  Turns partial human-object kinematic demonstrations into complete robot trajectories, then distills them into a G1 depth-plus-proprioception policy for autonomous door closing.
  Links: [Project](https://viloman-anonymous.pages.dev/) · [Paper](https://arxiv.org/abs/2609.19340)

- 🌐 🧍 🧱 **[Developing Combined Manipulation and Locomotion Skills with Interaction Representation and Skill Composition](https://arxiv.org/abs/2608.00208)** `Humanoids 2026 submission / arXiv 2026.08` `humanoid robot` `Loco-Manipulation`
  Fanxing Meng et al..
  Learns whole-body reaching and grasping, then composes it with standing-up and walking policies through hand-object interaction scores.
  Links: [Project](https://youtu.be/x-7x89fSJWY) · [Paper](https://arxiv.org/abs/2608.00208)
...
- 🌐 🧍 🧱 **[Whole-Body Planning for Humanoids Navigating Confined Spaces via Self-Collision Avoidance References](https://arxiv.org/abs/2608.10220)** `arXiv 2026.08` `Unitree G1` `WBC`
  Carlos Gonzalez et al..
  Generates collision-aware whole-body plans for G1 confined-space traversal and uses those plans as references for residual-RL execution.
  Links: [Project](https://carlosiglezb.github.io/confined-space-wbp-humanoid/) · [Paper](https://arxiv.org/abs/2608.10220)

- ⏳ 🤖 🧍 **[FetchMan: Learning Visual Humanoid Loco-Manipulation Policies from Simulated Experiences](https://arxiv.org/abs/2608.17027)** `arXiv 2026.08` `Unitree G1` `Loco-Manipulation`
  Omar Rayyan et al..
  Trains visual humanoid reach-and-pick policies from 150k simulated scenes and sparse-reward RL refinement, then deploys zero-shot on a real G1.
  Links: [Project](https://orayyan.com/fetchman) · [Code](https://github.com/omarrayyann/fetchman) · [Paper](https://arxiv.org/abs/2608.17027) · [Dataset](FetchMan-Bench announced on project page)

- ⏳ 🤖 🧍 **[Learning Multi-Humanoid Pickup and Transport via Decentralized Object-Centric Control](https://arxiv.org/abs/2609.17824)** `arXiv 2026.09` `multiple humanoids` `Loco-Manipulation`
  Bikram Pandit et al..
  Assigns each humanoid a local object attachment region so teams can learn pickup, transport, and handover through decentralized gripperless bimanual pinching.
  Links: [Project](https://decmht.github.io/) · [Paper](https://arxiv.org/abs/2609.17824)
...
- ⏳ 🤖 🧍 **[Whole-Body UMI: Transferring UMI Manipulation Skills to Humanoid Whole-Body Manipulation via Real-Time Motion Generation](https://arxiv.org/abs/2609.22829)** `arXiv 2026.09` `Unitree G1` `Loco-Manipulation`
  Yuxuan Nai et al..
  Transfers native UMI end-effector manipulation policies to whole-body humanoid execution through an asynchronous real-time motion generator and WBC layer.
  Links: [Project](https://wholebody-umi.github.io/) · [Paper](https://arxiv.org/abs/2609.22829)
...
- ⏳ 🧍 🧱 **[Unifying Physics-Based Humanoid Interaction with a Context-Conditioned Interaction Prior](https://arxiv.org/abs/2609.06591)** `SIGGRAPH Asia 2026 / arXiv 2026.09` `physics-based humanoid characters` `Loco-Manipulation`
  Jianan Li et al..
  Learns a shared discrete interaction prior from heterogeneous scene and object-interaction motions, then conditions it on task and environment context.
  Links: [Project](https://jiann-li.github.io/chip-project/) · [Paper](https://arxiv.org/abs/2609.06591)
...
- ❌ 🤖 🧍 **[$omega$-0: A Latent Predictive World Action Model for Concurrent Humanoid Loco-Manipulation](https://arxiv.org/abs/2608.06375)** `arXiv 2026.08` `household humanoid` `Loco-Manipulation`
  Zhe Li et al..
  Predicts controller-compatible whole-body action latents from language, vision, and proprioception for concurrent real-world humanoid household loco-manipulation.
  Links: [Paper](https://arxiv.org/abs/2608.06375)
...
- ❌ 🤖 🧍 **[Brace Yourself: Task-Conditioned Environmental Bracing for Forceful Humanoid Manipulation](https://arxiv.org/abs/2609.25486)** `RA-L submission / arXiv 2026.09` `Unitree G1` `Loco-Manipulation`
  Zongyuan Zhang et al..
  Learns a task-conditioned support-hand bracing strategy that lets a G1 exert much larger manipulation forces while preserving balance.
  Links: [Paper](https://arxiv.org/abs/2609.25486)
...
- ❌ 🤖 🧍 **[GLoRI: Closed-Loop Whole-Body Tracking with Global-Local Reference Interaction for Humanoid Loco-Manipulation](https://arxiv.org/abs/2609.05994)** `arXiv 2026.09` `Unitree G1 / humanoid loco-manipulation` `Loco-Manipulation`
  Qingyao Xu et al..
  Uses global-local cross attention to correct world-frame placement errors while preserving local motion structure for humanoid loco-manipulation tracking.
  Links: [Paper](https://arxiv.org/abs/2609.05994)

- ❌ 🤖 🧍 **[Hybrid Feedback Sampling for Sample-Efficient Model Predictive Control](https://arxiv.org/abs/2608.19443)** `arXiv 2026.08` `humanoid locomotion and manipulation tasks` `Loco-Manipulation`
  Chaoyi Pan et al..
  Improves sampling-based MPC by sampling around optimized feedback policies, with validation on contact-rich humanoid loco-manipulation and dexterous tasks.
  Links: [Paper](https://arxiv.org/abs/2608.19443)

- ❌ 🤖 🧍 **[KINO: A Keyframe Interface for VLM Planning and Whole-Body Control in Humanoid Loco-Manipulation](https://arxiv.org/abs/2609.18869)** `arXiv 2026.09` `Unitree G1` `Loco-Manipulation`
  Sitong Chen et al..
  Uses motion keyframes as the interface between VLM task planning and a keyframe-conditioned whole-body policy for G1 pickup, transport, and placement tasks.
  Links: [Paper](https://arxiv.org/abs/2609.18869)

- ❌ 🤖 🧍 **[Learning Distance-Conditioned Object Transport for Humanoid Loco-Manipulation from a Single Motion Clip](https://arxiv.org/abs/2609.21467)** `arXiv 2026.09` `humanoid` `Loco-Manipulation`
  Yuhyeon Hwang et al..
  Recombines a single retargeted transport clip into distance-conditioned references, then distills achieved object placements into a reference-free policy.
  Links: [Paper](https://arxiv.org/abs/2609.21467)

- ❌ 🤖 🧍 **[Learning Holistic Whole-Body Loco-Manipulation with a Bipedal Mobile Manipulator](https://arxiv.org/abs/2609.18930)** `arXiv 2026.09` `bipedal mobile manipulator with arm` `Loco-Manipulation`
  Zhongyu Chen et al..
  Trains a unified low-level controller that maps 6-DoF end-effector targets into coordinated stepping, reaching, and balance actions.
  Links: [Paper](https://arxiv.org/abs/2609.18930)
...
- ❌ 🤖 🧍 **[RoboReact: Agentic Skill Distillation from Generated Egocentric Videos for Generalizable Whole-Body Manipulation](https://arxiv.org/abs/2608.03387)** `arXiv 2026.08` `high-DoF humanoid` `Loco-Manipulation`
  Shuliang He et al..
  Converts generated human manipulation videos into object-grounded keyframes, retargets them to humanoids, and refines execution through VLM-guided closed-loop correction.
  Links: [Paper](https://arxiv.org/abs/2608.03387)
...
- ❌ 🤖 🧍 **[STRIDER: Stepping-Enabled Multi-Gait Hierarchical 3D Loco-Manipulation Framework for Humanoid Robots](https://arxiv.org/abs/2609.23483)** `ICRA 2027 submission / arXiv 2026.09` `TianGong Omni humanoid` `Loco-Manipulation`
  Yuanzhuo Li et al..
  Combines terrain-aware 3D stepping, AMP walking, and Cartesian upper-body control with latent-aligned distillation into one hardware-deployed humanoid policy.
  Links: [Paper](https://arxiv.org/abs/2609.23483)
...
- ❌ 🧍 🧱 **[Balancing of Humanoid with Object Mass: Trade-off Analyses and Lifting Control](https://arxiv.org/abs/2607.29625)** `arXiv 2026.07` `humanoid` `Loco-Manipulation`
  Hyunjong Song et al..
  Analyzes how object mass changes humanoid balance boundaries and uses those dynamics to design lifting and momentum-regulation controllers.
  Links: [Paper](https://arxiv.org/abs/2607.29625)
...
- ❌ 🧍 🧱 **[FRAMES: Failure Recovery And Monitoring of Embodied Skills for Humanoid Loco-Manipulation](https://arxiv.org/abs/2609.22538)** `IROS 2026 Workshop / arXiv 2026.09` `Unitree G1` `Loco-Manipulation`
  Ajay Vikram Periasami et al..
  Supervises parameterized G1 loco-manipulation skills with a planner, VLM monitor, recovery agent, semantic memory, and geometric grounding.
  Links: [Paper](https://arxiv.org/abs/2609.22538)
...
- ❌ 🧍 🧱 **[Stay Seated: Learning Omnidirectional Humanoid Locomotion on a Passive Mobile Chair with Casters](https://arxiv.org/abs/2608.28090)** `arXiv 2026.08` `Unitree G1 / passive mobile chair` `Loco-Manipulation`
  Kango Yanagida et al..
  Learns proprioceptive omnidirectional seated locomotion by modeling unfixed pelvis-seat contact and intermittent foot-floor propulsion of a humanoid-chair system.
  Links: [Paper](https://arxiv.org/abs/2608.28090)
...
| 2026 | [LAC: Linear and Angular Compliance for Humanoid Whole-body C](https://arxiv.org/abs/2608.25405) | Unitree G1 | ✅ | ⭐ Code | Trains a single policy to realize commanded linear and angular compliance for up |
...
| 2026 | [PAC-MAN: Perception-Aware CBF-RL for Whole-Body Safety in Hu](https://arxiv.org/abs/2607.28623) | Unitree G1 | ✅ | ⭐ Code | Couples control-barrier-function RL with onboard masked-depth perception so a G1 |
| 2026 | [Weave: Learning Whole-Body Dexterous Loco-Manipulation from ](https://arxiv.org/abs/2609.16683) | humanoid with 29 body joints and 12 actuated finger joints | ✅ | ⭐ Code | Converts captured human-object interactions into robot-object references, then t |
...
| 2026 | [P3: Probabilistic Policy Propagation for Stable VAE-Based Ro](https://arxiv.org/abs/2607.25541) | Unitree G1 / humanoid parkour tasks | — | ⭐ Code | Propagates latent uncertainty through PPO-style policy optimization to stabilize |
| 2026 | [PRISM: Polynomial Representations for Interaction-Structured](https://arxiv.org/abs/2607.23473) | Humanoid-Gym / contact-rich manipulation benchmarks | — | ⭐ Code | Adds compact factorized polynomial interaction features to MLP and diffusion-pol |
...
| 2026 | [A System for Fast, Resilient, and Adaptable Loco-Manipulatio](https://arxiv.org/abs/2609.01518) | Atlas, Valkyrie, Nadia, Unitree H1-2, Alex | ✅ | 🌐 Project Page | Combines object-centric affordance templates, behavior trees, runtime-editable p |
| 2026 | [Blind Dexterity: Whole-Body Humanoid Manipulation via Pure P](https://arxiv.org/abs/2608.29487) | Unitree G1 | ✅ | 🌐 Project Page | Trains G1 whole-body manipulation policies that infer object state from proprioc |
...
- 🌐 🤖 🧍 **[HAF: Adapting Generalist VLAs to Humanoid Whole-Body Loco-manipulation via Hierarchical Action Flow and Spectral Latent RL](https://arxiv.org/abs/2608.16837)** `arXiv 2026.08` `real-world humanoid loco-manipulation tasks` `Foundation`
  Langzhe Gu et al..
  Wraps a frozen flow-matching VLA with staged whole-body action generation and compact latent RL steering for humanoid loco-manipulation.
  Links: [Project](https://grange007.github.io/HAF/) · [Paper](https://arxiv.org/abs/2608.16837)
...
- 🌐 🤖 🧍 **[WholeBodyWAM: Generalizing Pre-trained World-Action Priors to Humanoid Loco-Manipulation via WBC-Grounded Coordination](https://arxiv.org/abs/2609.16644)** `arXiv 2026.09` `humanoid loco-manipulation` `Foundation`
  Zhuo Li et al..
  Extends pretrained world-action priors with WBC-grounded coordination signals so humanoid policies predict visual dynamics, manipulation actions, and whole-body intents together.
  Links: [Project](https://wholebodywam.github.io/) · [Paper](https://arxiv.org/abs/2609.16644)
...
- ⏳ 🤖 🧍 **[WholeBodyWAM: Learning Whole-Body World Action Models with Scalable Motion Priors](https://arxiv.org/abs/2609.18197)** `arXiv 2026.09` `real-world humanoid manipulation` `Foundation`
  Bowei Zhang et al..
  Pretrains a language-conditioned motion expert on heterogeneous human and humanoid motion, then integrates it with video and action experts for target-robot post-training.
  Links: [Project](https://zbzyjya.github.io/WholeBodyWAM/) · [Paper](https://arxiv.org/abs/2609.18197) · [Dataset](UniMotion-4K announced in paper)
...
- ❌ 🤖 🧍 **[CLIFT: Turning Gemini Robotics On-Device into Humanoid Specialists via Non-Invasive Closed-Loop Iterative Fine-Tuning](https://arxiv.org/abs/2607.29172)** `arXiv 2026.07` `humanoid manipulation` `Foundation`
  Yuxin Chen et al..
  Studies closed-loop adaptation of a managed closed-weight robot foundation model for contact-rich humanoid manipulation without access to model weights or gradients.
  Links: [Paper](https://arxiv.org/abs/2607.29172)
...
- ❌ 🤖 🧍 **[EATR-Stereo: Embodiment-Aware Token Routing of Paired Stereo Evidence for Humanoid Vision-Language-Action Control](https://arxiv.org/abs/2608.17453)** `arXiv 2026.08` `33-DoF physical humanoid` `Foundation`
  Songwei Wu et al..
  Routes auxiliary stereo-view tokens into a frozen VLA according to primary-view alignment and body-segment proprioception for humanoid manipulation.
  Links: [Paper](https://arxiv.org/abs/2608.17453)
...
- ❌ 🤖 🧍 **[X-WBC: A Cross-Embodiment Foundation Model for Humanoid Whole-Body Control](https://arxiv.org/abs/2609.15213)** `CoRL 2026 / arXiv 2026.09` `nine simulated embodiments / four real humanoids` `Foundation`
  Juntong Zhang et al..
  Separates shared human motion semantics from robot-specific execution modules so heterogeneous humanoids can jointly train a reusable WBC representation.
  Links: [Paper](https://arxiv.org/abs/2609.15213)

- ❌ 🤖 🧍 **[XPACE: Joint World and Action Modeling from Heterogeneous Experience](https://arxiv.org/abs/2609.17372)** `arXiv 2026.09` `XPENG IRON humanoid` `Foundation`
  Jiacheng Wei et al..
  Jointly models future video and executable robot actions from heterogeneous human and robot experience, then uses its simulator to synthesize recovery supervision.
  Links: [Paper](https://arxiv.org/abs/2609.17372)
...
| Year | Paper | Robot/Data | Real Robot | Code | Key Idea |
|---|---|---|---|---|---|
| 2026 | [AnyWorld: Factorized Egocentric World Models for Cross-Embod](https://arxiv.org/abs/2608.29242) | RoboCasa GR1 / IRON humanoid robot | ✅ | ⭐ Code | Factorizes egocentric interaction data into action, camera, and embodiment contr |
...
| 2026 | [HAF: Adapting Generalist VLAs to Humanoid Whole-Body Loco-ma](https://arxiv.org/abs/2608.16837) | real-world humanoid loco-manipulation tasks | ✅ | 🌐 Project Page | Wraps a frozen flow-matching VLA with staged whole-body action generation and co |
...
| 2026 | [WholeBodyWAM: Generalizing Pre-trained World-Action Priors t](https://arxiv.org/abs/2609.16644) | humanoid loco-manipulation | ✅ | 🌐 Project Page | Extends pretrained world-action priors with WBC-grounded coordination signals so |
| 2026 | [One Policy, Many Embodiments: Unified Camera-Centric Action ](https://arxiv.org/abs/2608.26058) | humanoids / robot arms / human hands | ✅ | ⏳ Code Coming Soon | Pretrains a single VLA policy over camera-observable anchor motions, then transl |
| 2026 | [WholeBodyWAM: Learning Whole-Body World Action Models with S](https://arxiv.org/abs/2609.18197) | real-world humanoid manipulation | ✅ | ⏳ Code Coming Soon | Pretrains a language-conditioned motion expert on heterogeneous human and humano |
| 2026 | [CLIFT: Turning Gemini Robotics On-Device into Humanoid Speci](https://arxiv.org/abs/2607.29172) | humanoid manipulation | ✅ | ❌ No Code | Studies closed-loop adaptation of a managed closed-weight robot foundation model |
...
- ⏳ 🤖 🧍 **[C2Dex: Contact-Consistent Reconstruction and Retargeting for Dexterous Manipulation from Monocular Video](https://arxiv.org/abs/2608.07045)** `arXiv 2026.08 (v2 Sep 2026)` `Inspire dexterous hand / humanoid-relevant dexterous hands` `Retargeting`
  Jie Ren et al..
...
- ⏳ 🤖 **[Morphometric Imitation: From Morphology and Contact Aware Hand Retargeting to Sim-to-Real Visuomotor Policy](https://arxiv.org/abs/2609.28660)** `arXiv 2026.09` `dexterous robot hands / humanoid-relevant manipulation` `Retargeting`
  Tara Sadjadpour et al..
  Retargets reconstructed human hand-object interactions across robot hand morphologies, refines them with residual RL, and distills zero-shot visuomotor policies.
  Links: [Project](https://morphometricimitation.github.io/) · [Code](https://github.com/tsadja/morphometric) · [Paper](https://arxiv.org/abs/2609.28660)
...
- ❌ 🤖 **[Hand-centric Human-to-Robot Trajectory Transfer from Video Demonstrations via Object Category-agnostic Temporal Localization](https://arxiv.org/abs/2606.10743)** `arXiv 2026.06` `robot arms / manipulation` `Retargeting`
  Yitian Shi et al..
...
- ❌ 🤖 **[ReForce: Learning Force-aware Retargeting for Dexterous Manipulation](https://arxiv.org/abs/2608.15560)** `arXiv 2026.08` `multi-finger dexterous hands / humanoid-relevant manipulation` `Retargeting`
  Yuhang Wu et al..
  Predicts force-tracking residuals on top of kinematic retargeting so human demonstrations transfer with stronger multi-finger contact engagement.
  Links: [Paper](https://arxiv.org/abs/2608.15560)

- ❌ 🤖 **[RoboEdit: Turning Human Manipulation Videos into Scalable Robot Experience](https://arxiv.org/abs/2608.18948)** `arXiv 2026.08` `seven robot embodiments / dexterous manipulation` `Retargeting`
  Yaowei Guo et al..
  Edits human manipulation videos into robot-consistent videos with aligned 3D hand states and cross-embodiment retargeted supervision.
  Links: [Paper](https://arxiv.org/abs/2608.18948) · [Dataset](RoboEdit-14M announced in paper)

- ❌ 🤖 🧍 **[Unified Motion Retargeting for Humanoids with Learned Point Cloud Correspondence](https://arxiv.org/abs/2609.02134)** `arXiv 2026.09 (v2 Sep 2026)` `multiple humanoids / SONIC-style trackers` `Retargeting`
  Hanyang Cao et al..
  Learns dense human-to-humanoid point-cloud correspondences so retargeting no longer depends on manually designed sparse keypoint or body-part mappings.
  Links: [Paper](https://arxiv.org/abs/2609.02134)
...
- ❌ 🧍 🧱 **[Morphology-Aware Human Motion Retargeting for Wheeled-Humanoid Loco-Manipulation](https://arxiv.org/abs/2609.11357)** `arXiv 2026.09` `Galaxea R1 Pro wheeled humanoid` `Retargeting`
  Chenbo Xia et al..
  Converts SMPL-X human motion into executable loco-manipulation behaviors for a wheeled humanoid by redistributing lower-body motion across base and torso motion.
  Links: [Paper](https://arxiv.org/abs/2609.11357)
...
| Year | Paper | Robot/Data | Real Robot | Code | Key Idea |
|---|---|---|---|---|---|
| 2026 | [BeyondRetarget: Learning Executable Humanoid Motions Directl](https://arxiv.org/abs/2609.29850) | Unitree G1 / R1 / H1, Fourier GR1/GR2, Atlas, Booster T1, Tienkung | ✅ | ⭐ Code | Maps monocular RGB video directly into executable humanoid trajectories through  |
| 2026 | [Shooting for Contact: Contact-Implicit Multiple Shooting for](https://arxiv.org/abs/2608.03116) | Unitree G1 / Go2 / legged systems | ✅ | ⭐ Code | Uses contact-implicit direct simulation multiple shooting to convert kinematic r |
...
| 2026 | [C2Dex: Contact-Consistent Reconstruction and Retargeting for](https://arxiv.org/abs/2608.07045) | Inspire dexterous hand / humanoid-relevant dexterous hands | ✅ | ⏳ Code Coming Soon | Reconstructs contact-consistent human hand-object trajectories from monocular vi |
...
| 2026 | [Morphometric Imitation: From Morphology and Contact Aware Ha](https://arxiv.org/abs/2609.28660) | dexterous robot hands / humanoid-relevant manipulation | ✅ | ⏳ Code Coming Soon | Retargets reconstructed human hand-object interactions across robot hand morphol |
...
| 2026 | [ReForce: Learning Force-aware Retargeting for Dexterous Mani](https://arxiv.org/abs/2608.15560) | multi-finger dexterous hands / humanoid-relevant manipulation | ✅ | ❌ No Code | Predicts force-tracking residuals on top of kinematic retargeting so human demon |
| 2026 | [RoboEdit: Turning Human Manipulation Videos into Scalable Ro](https://arxiv.org/abs/2608.18948) | seven robot embodiments / dexterous manipulation | ✅ | ❌ No Code | Edits human manipulation videos into robot-consistent videos with aligned 3D han |
| 2026 | [Unified Motion Retargeting for Humanoids with Learned Point ](https://arxiv.org/abs/2609.02134) | multiple humanoids / SONIC-style trackers | ✅ | ❌ No Code | Learns dense human-to-humanoid point-cloud correspondences so retargeting no lon |
...
- ⏳ 🤖 🧍 **[MATE: Multi-Agent Virtual Teleoperation Platform for Humanoid Collaboration Data Collection](https://arxiv.org/abs/2609.26520)** `arXiv 2026.09` `multi-humanoid collaboration` `Teleoperation`
  Yichuan Yu et al..
  Lets distributed operators teleoperate multiple whole-body humanoids in one physics environment and collects coordinated interaction demonstrations.
  Links: [Project](https://yerik-yu.github.io/MATE/) · [Paper](https://arxiv.org/abs/2609.26520)
...
- ❌ 🤖 🧍 **[Event-Based Upper-Body Humanoid Teleoperation Under Challenging Illumination](https://arxiv.org/abs/2607.29227)** `arXiv 2026.07` `Booster T1 / 18-DoF humanoid upper body` `Teleoperation`
  Haoyu Fu et al..
  Uses event-camera perception with inertial fusion and causal TWIST retargeting for low-latency upper-body humanoid teleoperation under difficult lighting.
  Links: [Paper](https://arxiv.org/abs/2607.29227)
...
- ❌ 🤖 🧍 **[SPOT: Spatial Perception-Oriented Long-Horizon Humanoid Teleoperation](https://arxiv.org/abs/2609.07933)** `arXiv 2026.09` `humanoid teleoperation platform` `Teleoperation`
  Lixing Fang et al..
  Uses a wide-field stabilized stereoscopic VR interface with viewpoint-decoupled free-looking to improve long-horizon humanoid demonstration collection.
  Links: [Paper](https://arxiv.org/abs/2609.07933)
...
- ❌ 🧍 🧱 **[Gated Residual Body-Hand Coordination for Whole-Body Humanoid Teleoperation](https://arxiv.org/abs/2609.18763)** `arXiv 2026.09` `Agile One humanoid` `Teleoperation`
  Ruiming Wu et al..
  Keeps the body tracker and hand retargeter frozen, then learns gated residual corrections that reduce wrist and fingertip geometry errors during bimanual teleoperation.
  Links: [Paper](https://arxiv.org/abs/2609.18763)
...
| Year | Paper | Robot/Data | Real Robot | Code | Key Idea |
|---|---|---|---|---|---|
| 2026 | [Teleopit: A Full-Embodiment Humanoid Teleoperation System](https://arxiv.org/abs/2608.01834) | Unitree G1 / configurable dexterous hands | ✅ | ⭐ Code | Maps VR body, hand, and head signals into humanoid body motion, dexterous hands, |
...
| 2026 | [MATE: Multi-Agent Virtual Teleoperation Platform for Humanoi](https://arxiv.org/abs/2609.26520) | multi-humanoid collaboration | ✅ | ⏳ Code Coming Soon | Lets distributed operators teleoperate multiple whole-body humanoids in one phys |
...
| 2026 | [Event-Based Upper-Body Humanoid Teleoperation Under Challeng](https://arxiv.org/abs/2607.29227) | Booster T1 / 18-DoF humanoid upper body | ✅ | ❌ No Code | Uses event-camera perception with inertial fusion and causal TWIST retargeting f |
...
| 2026 | [SPOT: Spatial Perception-Oriented Long-Horizon Humanoid Tele](https://arxiv.org/abs/2609.07933) | humanoid teleoperation platform | ✅ | ❌ No Code | Uses a wide-field stabilized stereoscopic VR interface with viewpoint-decoupled  |
...
| 2026 | [Gated Residual Body-Hand Coordination for Whole-Body Humanoi](https://arxiv.org/abs/2609.18763) | Agile One humanoid | — | ❌ No Code | Keeps the body tracker and hand retargeter frozen, then learns gated residual co |
...
- 📦 🤖 🧍 **[HiPHI: A Large-Scale Benchmark for High-Precision Human Motion and Object-Interaction](https://arxiv.org/abs/2608.16222)** `CoRL 2026 / arXiv 2026.08 (v2 Sep 2026)` `human motion data / Unitree G1 policy evaluation` `Dataset`
  Jiahao Ji et al..
  Releases a 600-hour-scale high-precision whole-body human motion and object-interaction benchmark with motion diversity and grounding metrics.
  Links: [Project](https://noitom-robotics.github.io/hiphi/) · [Code](https://github.com/noitom-robotics/hiphi) · [Paper](https://arxiv.org/abs/2608.16222) · [Dataset](https://huggingface.co/datasets/noitomrobotics/HiPHI)

- 📦 **[ACE-Data-0: Human-Centric Ambient Capture as Embodied Data Engine](https://arxiv.org/abs/2607.28625)** `arXiv 2026.07` `N/A (human demonstrations for embodied AI)` `Dataset`
  Yukang Cao et al..
  Releases a synchronized home-capture dataset with egocentric and exocentric video, full-body and hand motion, object trajectories, audio, and tactile signals.
  Links: [Project](https://ace-data-engine.github.io/ACE-Data-0/) · [Paper](https://arxiv.org/abs/2607.28625) · [Dataset](https://huggingface.co/datasets/ACERobotics/ACE-Data-0)
...
- ❌ 🤖 🧍 **[How to Better Train VLAs: Lessons Learned From the REAL-I Challenge at ICRA 2026](https://arxiv.org/abs/2609.13679)** `ICRA 2026 REAL-I Challenge report / arXiv 2026.09` `shared dual-arm humanoid platform` `Dataset`
  Jiaming Wang et al..
  Summarizes the REAL-I Challenge tasks, shared humanoid deployment setup, winning approaches, and lessons for training VLAs from a fixed demonstration budget.
  Links: [Paper](https://arxiv.org/abs/2609.13679)
...
| Year | Paper | Robot/Data | Real Robot | Code | Key Idea |
|---|---|---|---|---|---|
| 2026 | [HiPHI: A Large-Scale Benchmark for High-Precision Human Moti](https://arxiv.org/abs/2608.16222) | human motion data / Unitree G1 policy evaluation | ✅ | 📦 Dataset | Releases a 600-hour-scale high-precision whole-body human motion and object-inte |
| 2026 | [ACE-Data-0: Human-Centric Ambient Capture as Embodied Data E](https://arxiv.org/abs/2607.28625) | N/A (human demonstrations for embodied AI) | — | 📦 Dataset | Releases a synchronized home-capture dataset with egocentric and exocentric vide |
...
| 2026 | [HumanoidVLN: A Physics-Grounded Simulator and Benchmark for ](https://arxiv.org/abs/2608.12860) | Unitree G1 / Unitree H1 / custom humanoids | — | ⏳ Code Coming Soon | Builds a physics-grounded VLN benchmark across multiple humanoid embodiments wit |
| 2026 | [How to Better Train VLAs: Lessons Learned From the REAL-I Ch](https://arxiv.org/abs/2609.13679) | shared dual-arm humanoid platform | ✅ | ❌ No Code | Summarizes the REAL-I Challenge tasks, shared humanoid deployment setup, winning |
...
- 🌐 **[HOPE: Hand-Object Pressure Estimation from Monocular Videos](https://arxiv.org/abs/2608.06192)** `arXiv 2026.08` `hand-object interaction data` `Contact Metrics`
  Subin Jeon et al..
  Predicts temporally evolving hand-mesh pressure and contact from monocular hand-object videos by aligning tactile-glove, planar-sensor, and contact-distance supervision.
  Links: [Project](https://subin6.github.io/page-hope) · [Paper](https://arxiv.org/abs/2608.06192)

- ❌ 🧱 **[EgoPHI: Estimating 3D Hand-Object Contact and Force from Egocentric Vision](https://arxiv.org/abs/2608.13014)** `ECCV 2026 / arXiv 2026.08` `hand-object interaction data` `Contact Metrics`
  Andela Ilic et al..
...
| Year | Paper | Robot/Data | Real Robot | Code | Key Idea |
|---|---|---|---|---|---|
| 2026 | [HumanTracker: Towards Comprehensive and Human-Aligned Motion](https://arxiv.org/abs/2608.13555) | Unitree G1 / humanoid trackers | — | ⭐ Code | Releases a humanoid tracking benchmark and HumanScore preference metric that bet |
| 2026 | [HOPE: Hand-Object Pressure Estimation from Monocular Videos](https://arxiv.org/abs/2608.06192) | hand-object interaction data | — | 🌐 Project Page | Predicts temporally evolving hand-mesh pressure and contact from monocular hand- |
| 2026 | [EgoPHI: Estimating 3D Hand-Object Contact and Force from Ego](https://arxiv.org/abs/2608.13014) | hand-object interaction data | — | ❌ No Code | Estimates dense hand/object contact maps and 3D force distributions from egocent |
| 2026 | [Policy-Induced Hand Priors in Humanoid Dual-Arm Manipulation](https://arxiv.org/abs/2608.11769) | humanoid dual-arm manipulation | — | ❌ No Code | Diagnoses pose-conditioned hand-selection bias in humanoid VLA manipulation poli |
